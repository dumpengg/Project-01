...
public class Controller extends SimEntity{
	...
	private void printCostDetails(){
        ...
        if (cloud != null) {
            System.out.println("Cost of execution in cloud = "+cloud.getTotalCost());
        } else {
            System.out.println("No cloud device found. Cost of execution in cloud = N/A");
        }
    }
	...
	private void printTimeDetails() {
		...
		for(Integer loopId : TimeKeeper.getInstance().getLoopIdToTupleIds().keySet()){
			...
			double average = (count > 0) ? totalDelay / count : 0.0;
			System.out.println(getStringForLoopId(loopId) + " ---> " + average);
		}
		System.out.println("=========================================");
    ...
    public double getCloudCost() {
        FogDevice cloud = getCloud();
        return (cloud != null) ? cloud.getTotalCost() : 0.0;
    }
}
